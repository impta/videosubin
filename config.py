...
class Config:
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "5062201942:AAFqRnF6fxMJfTOHpr7LstDYU2WskY9ug1w")     
    ...
    CHAT = int(os.environ.get("CHAT", "-1001599715690"))
    LOG_GROUP=os.environ.get("LOG_GROUP", "-1001799098069")
